...
/**
 * Sets the ongoing action (placing the Family Member to a Council Cell) and goes to the Family Member choice
 * 
 * @author yazan-matar
 *
 */
public class FamtoCouncilTrigger implements ActionChoice {
	 ...
	 * that can be put in a Council Cell: 
	 * <ol> 
