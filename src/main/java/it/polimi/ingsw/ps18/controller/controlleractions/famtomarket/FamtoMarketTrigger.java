...
/**
 * Sets the ongoing action (placing the Family Member to a Market Cell) and goes to the Family Member choice
 * 
 * @author yazan-matar
 *
 */
public class FamtoMarketTrigger implements ActionChoice {
	 ...
	 * that can be put in a Market Cell: 
	 * <ol> 
	 * <li> It checks the Market status:
	 * <ul>
	 * 	<li> If the Market is full, it returns to the action choice
	 *  <li> Else, it finds the Family Member with the greater Action Value and eventually adds
