...
/**
 * The Class AddPVforGreenC.
 */
public class AddPVforGreenC implements FinalEffect, HarvestEffect, ProductionEffect, QuickEffect {
	...
	public String toString(){
		...
		builder.append(" for every Green Card you have.");
