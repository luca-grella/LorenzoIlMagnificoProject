...
/**
 * The Class TakeBlueCard.
 */
public class TakeBlueCard extends Observable implements FinalEffect, HarvestEffect, ProductionEffect, QuickEffect {
	
	/**
	 * The name.
	 */
	private String name = "Take a Card from the Blue Tower";
	...
	public void activate(PBoard player, GameLogic game) {
		...
		((FamtoTower) action).setChosenTower(1);
		setChanged();
		notifyObservers(new ParamMessage("Floor Choice",1));		
	}
	...
	public String toString(){
		...
		builder.append("Take a card from the Blue Tower with an Action Value of " + this.quantity);
